...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
         ...
         */
        // single
        // I had to comment this and replace it with my code below, to call setPlaceholder before updateSelection
        /*
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        // multi
        // I had to comment this and replace with code below to make it work
        /* 
        initSelection: function () {
            var data;
            if (this.opts.element.val() === "" && this.opts.element.text() === "") {
